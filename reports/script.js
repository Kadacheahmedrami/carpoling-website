...
// Sélectionnez tous les boutons "Bannir"
let banButtons = document.querySelectorAll('.ban-btn');

// Sélectionnez le conteneur de confirmation
let confirmationContainer = document.querySelector('.container');

// Sélectionnez l'élément de fond flou
let blurBackground = document.getElementById('blur-background');

// Ajoutez un événement de clic à chaque bouton "Bannir"
banButtons.forEach(function(button) {
    button.addEventListener('click', function() {
        // Afficher le conteneur de confirmation en tant que flex
        confirmationContainer.style.display = 'flex';
        
        // Afficher le fond flou
        blurBackground.style.display = 'block';
    });
});

// Sélectionnez le bouton "ANNULER" dans le conteneur de confirmation
let cancelButton = document.querySelector('.Annuler');

// Ajoutez un événement de clic au bouton "ANNULER"
cancelButton.addEventListener('click', function() {
    // Cacher le conteneur de confirmation
